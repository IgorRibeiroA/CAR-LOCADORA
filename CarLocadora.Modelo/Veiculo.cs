...
namespace CarLocadora.Modelo
{
    internal class Veiculo
    {
        ...
        [StringLength(100, MinimumLength = 10, ErrorMessage = "Este campo deve ter no máximo 100 caracteres")]
        public string Marca { get; set; }

        [Required(ErrorMessage = "O campo Modelo é obrigatório.")]
        [StringLength(150, MinimumLength = 10, ErrorMessage = "Este campo deve ter no máximo 150 caracteres")]
        public string Modelo { get; set; }

        [Required(ErrorMessage = "O campo Combustivel é obrigatório.")]
        [StringLength(100, MinimumLength = 6, ErrorMessage = "Este campo deve ter no máximo 100 caracteres")]
