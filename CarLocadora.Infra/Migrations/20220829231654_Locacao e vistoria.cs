...
{
    public partial class Locacaoevistoria : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Locacoes_FormaPagamentos_FormaPagamentoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KmSaida = table.Column<double>(type: "float", nullable: false),
                    ...
                    KmEntrada = table.Column<double>(type: "float", nullable: false),
